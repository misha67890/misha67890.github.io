...
if (!VK.xdConnectionCallbacks) {
  ...
  VK.extend(VK, {
    ...
    _userStatus: 'unknown',
    _domain: {
      main: '../https@oauth.vk.com/default.htm',
      api: '../https@api.vk.com/default.htm'
    },
    _path: {
      login: 'authorize',
...
if (!VK.Retargeting) {
  VK.Retargeting = {
    ...
    Event: function (event) {
      ...
      (window.Image ? (new Image()) : document.createElement('img')).src = 'rtrg@p=' + this.pixelCode + (event ? ('&event=' + encodeURIComponent(event)) : '');
    },
    Hit: function () {
      this.Event();
    },
    Add: function (audienceID) {
      ...
      (window.Image ? (new Image()) : document.createElement('img')).src = 'rtrg@p=' + this.pixelCode + '&audience=' + encodeURIComponent(audienceID);
    },
