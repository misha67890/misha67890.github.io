...
(function(w) {
  ...
  if ((flash[0] < 10 || supportsNIX()) && "ActiveXObject" in w && "execScript" in w) {
    ...
    function addSwf(lcName, isClient) {
      ...
      var src = '../vk.com/swf/xdmHelper.swf';
      //src += '?r='+Math.random();

      document.body.appendChild(fobj);

      fobj.outerHTML = '<object style="position: fixed; top: 0px; left: 0px;" id="_fxdm_fl" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="../fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0/#version=9,0,0,0/default.htm" width="1" height="1">\
